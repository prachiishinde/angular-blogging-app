...
@Component({
  selector: 'app-my-post-main',
  templateUrl: './my-post-main.component.html',
  styleUrls: ['./my-post-main.component.css']
})
export class MyPostMainComponent {
  constructor(private dialog:MatDialog){
  
  }

  Openpopup(){
    this.dialog.open(MyPostMainComponent ,{
      width: '40%',
      data:{
        title: 'User Edit'
      }
